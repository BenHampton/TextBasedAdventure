class Item:
    ...
    def __inti__(self, name, description, value):
        self.name = name
...
class Gold(Item):
    def __inti__(self, amt):
        self.amt = amt
        super.__init__(name = "Gold", description = "A round coin with {} stamped on the front.".format(str(amt)), value = self.amt)
